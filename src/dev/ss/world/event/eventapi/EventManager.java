...
public final class EventManager
{
    ...
    private static void register(final Method method, final Object object) {
        ...
        final MethodData data = new MethodData(object, method, method.getAnnotation(ShellEvent.class).value());
    ...
    private static boolean isMethodBad(final Method method) {
        return method.getParameterTypes().length != 1 || !method.isAnnotationPresent(ShellEvent.class);
    }
