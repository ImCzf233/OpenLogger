...
public class Window
{
    ...
    public Window(final Category category, final int x, final int y) {
        ...
        this.max = 120;
        int y2 = y + 25;
        for (final Mod c : ShellSock.getClient().modManager.getModulesInCategory(category)) {
    ...
    public void render(final int mouseX, final int mouseY) {
        ...
        if (this.category.name().equals("COMBAT")) {
            this.staticColor = new Color(255, 255, 255).getRGB();
        }
        ...
        else if (this.category.name().equals("CLIENT")) {
            this.staticColor = new Color(255, 255, 255).getRGB();
        }
        if (this.expand > 0) {
            RenderUtils.rectangleBordered(this.x - 0.5, this.y - 0.5, this.x + 90.5, this.y + 1.5 + this.expand, 1.0, this.staticColor, this.staticColor);
            RenderUtils.rectangleBordered(this.x, this.y, this.x + 90, this.y + 1.0 + this.expand, 1.0, new Color(25, 25, 25).getRGB(), new Color(25, 25, 25).getRGB());
        }
        RenderUtils.drawGradientRect(this.x, this.y, this.x + 90, this.y + 17, new Color(25, 25, 25).getRGB(), new Color(25, 25, 25).getRGB());
        final ScaledResolution res = new ScaledResolution(Minecraft.getMinecraft());
        if (this.category.name().equals("COMBAT")) {
            FontManager.default16.drawCenteredString("COMBAT", this.x + 80 - FontManager.default16.getStringWidth("COMBAT"), this.y + 6, new Color(220, 220, 220).getRGB());
        }
        if (this.category.name().equals("VISUAL")) {
            FontManager.default16.drawCenteredString("VISUAL", this.x + 76 - FontManager.default16.getStringWidth("VISUAL"), this.y + 6, new Color(220, 220, 220).getRGB());
        }
        if (this.category.name().equals("MOVEMENT")) {
            FontManager.default16.drawCenteredString("MOVEMENT", this.x + 94 - FontManager.default16.getStringWidth("MOVEMENT"), this.y + 6, new Color(220, 220, 220).getRGB());
        }
        if (this.category.name().equals("PLAYER")) {
            FontManager.default16.drawCenteredString("PLAYER", this.x + 76 - FontManager.default16.getStringWidth("PLAYER"), this.y + 6, new Color(220, 220, 220).getRGB());
        }
        if (this.category.name().equals("CLIENT")) {
            FontManager.default16.drawCenteredString("CLIENT", this.x + 76 - FontManager.default16.getStringWidth("CLIENT"), this.y + 6, new Color(220, 220, 220).getRGB());
        }
        if (this.expand > 0) {
