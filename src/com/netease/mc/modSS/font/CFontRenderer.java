...
public class CFontRenderer extends CFont
{
    ...
    public float Ex(final String text, final double x2, final double y2, final int color) {
        final float shadowWidth = this.drawString(text, x2 + 0.7, y2 + 0.6, color, true);
        return Math.max(shadowWidth, this.drawString(text, x2, y2, color, false));
    }
    
    public static void drawOutlinedStringCock(final FontRenderer fr, final String s, final float x, final float y, final int color, final int outlineColor) {
        fr.drawStringWithShadow(Colors.stripColor(s), x - 1.0f, y, outlineColor);
        fr.drawStringWithShadow(Colors.stripColor(s), x, y - 1.0f, outlineColor);
        fr.drawStringWithShadow(Colors.stripColor(s), x + 1.0f, y, outlineColor);
        fr.drawStringWithShadow(Colors.stripColor(s), x, y + 1.0f, outlineColor);
